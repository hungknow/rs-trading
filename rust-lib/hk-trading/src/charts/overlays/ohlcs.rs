...
impl Ohlcs {
    pub fn new(candles: &Candles, drawing_area_width: u32) -> Self {
        ...
        Self {
            ...
            from_time: None,
            to_time: None,
            drawing_area_width: drawing_area_width,
            candlesticks: None,
            previous_from_time: None,
            previous_to_time: None,
        }
    ...
    pub fn get_ohlcs(
        ...
        let candle_width = candle_step * 1.0; // 0.6;
...
mod tests {
    ...
    #[test]
    fn test_get_ohlcs() {
        let ohlcs = Ohlcs::new(&Candles::new(), 400);
        let bar_count = 10;
