use crate::charts::{style::{Color, ShapeStyle, SizeDesc}, BackendCoord, DrawingBackend, DrawingErrorKind};

use super::{Drawable, IntoDynElement, PointCollection};
...
//     use crate::charts::{drawing::create_mocked_drawing_area, style::RED};
...
//     use crate::charts::{drawing::create_mocked_drawing_area, style::BLUE};
//     let da = create_mocked_drawing_area(300, 300, |m| {
...
fn test_rect_element() {
    use crate::charts::{drawing::create_mocked_drawing_area, style::{Color, BLUE}};
    {
        let da = create_mocked_drawing_area(300, 300, |m| {
...
//     let da = create_mocked_drawing_area(800, 800, |m| {
